...
extension ToDo {
    static var preview: ModelContainer {
        ...
        // Add mock data
        container.mainContext.insert(ToDo(item: "Create SwiftData Lessons", reminderIsOn: true, dueDate: Calendar.current.date(byAdding: .day, value: 1, to: Date.now)!, notes: "Now with iOS 16 & Xcode 18", isCompleted: false))
